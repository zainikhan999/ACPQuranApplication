...
//         // Save the user data (excluding sensitive info like password) to localStorage
//         // const userData = { userName, firstName, lastName, email, contact };
//         // const userData = { userName, firstName, lastName, email, contact };
...
//         // Immediately navigate to the dashboard without waiting for the popup timeout
//         setTimeout(() => {
//           setShowPopup(false);
//           navigate('/Dashboard'); // Navigate to the dashboard after successful signup
//         }, 3000); // You can adjust this timeout as per your needs, or remove it if unnecessary
//       }
//     } catch (error) {
//       if (error.response?.data?.message) {
//         const { message } = error.response.data;
  
//         // Set specific error messages based on the conflict field
...
//   return (
//     <>
//       <form onSubmit={handleSubmit} className="max-w-md mx-auto p-6 bg-white border border-gray-300 rounded-lg shadow-lg">
//         <h1 className="text-3xl font-bold text-center mb-6">Sign Up</h1>

//         {/* Form fields for userName, firstName, lastName, email, password, contact */}
//         <div>
